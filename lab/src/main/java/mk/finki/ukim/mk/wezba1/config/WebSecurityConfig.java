package mk.finki.ukim.mk.wezba1.config;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        .requestMatchers("/", "/login", "/assets/**", "/events", "events/details/", "/events/searchEvent","register")
                        .permitAll()
                        .requestMatchers("/events/add", "/eventBooking").hasAnyRole("USER", "ADMIN")
